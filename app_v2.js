...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Debug DOM Elements
    const menuBtnCheck = document.getElementById('menu-btn');
    console.log('Menu Button found:', !!menuBtnCheck);

    if (menuBtnCheck) {
        menuBtnCheck.addEventListener('click', (e) => {
            console.log('🍔 Menu Clicked via Inline Listener');
            toggleSidebar();
        });
    }
